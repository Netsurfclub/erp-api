...
class UpdateSupplierInputTestObject {
    companion object {
        ...
        fun input1WithLongName(): UpdateSupplierInput = build(name = SUPPLIER_1_LONG_NAME)

        fun input1WithNullName(): UpdateSupplierInput = build(name = null)

        fun input1WithShortPhone(): UpdateSupplierInput = build(phone = "1")

        fun input1WithLongPhone(): UpdateSupplierInput = build(phone = SUPPLIER_1_LONG_PHONE)

        fun input1WithNullPhone(): UpdateSupplierInput = build(phone = null)

        fun input1WithShortEmail(): UpdateSupplierInput = build(email = "a")

        fun input1WithLongEmail(): UpdateSupplierInput = build(email = SUPPLIER_1_LONG_EMAIL)

        fun input1WithInvalidEmail(): UpdateSupplierInput = build(email = SUPPLIER_1_INVALID_EMAIL)
